  ...
  test: {
    coverage: {
      include: [
        ...
        "packages/focus-mode/config.ts",
        "packages/focus-mode/store.ts",
        "packages/focus-mode/gate.ts",
        "packages/focus-mode/converge.ts",
        "packages/focus-mode/notice.ts",
        "packages/focus-mode/editor.ts",
