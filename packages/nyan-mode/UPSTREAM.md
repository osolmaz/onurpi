...
- Added a fixed-width ANSI kaomoji with elongating rainbow bands and streaming dance poses for Mosh and other transports without Kitty graphics support, with an explicit text mode override.
