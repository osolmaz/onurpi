...
- Derive edit diffstats and edited-file paths only from successful finalized tool-result patches. Resolve relative patch paths against Pi's documented `ctx.cwd`; do not inspect Git or snapshot files.
