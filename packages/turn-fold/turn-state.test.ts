...
describe("historical transcript", () => {
  ...
  it("reconstructs extension-started runs from persisted boundaries", () => {
    ...
    state.loadHistory([
      ...
      { id: "ext-answer-1", message: first, type: "message" },
      {
        customType: TURN_FOLD_RUN_ENTRY,
        data: { promptEntryId: "ext-prompt-1", runId: "ext-run-1", startedAt: 100, version: 1 },
        id: "boundary-1",
        type: "custom",
      },
      {
      ...
      { id: "ext-answer-2", message: second, type: "message" },
      {
        customType: TURN_FOLD_RUN_ENTRY,
        data: { promptEntryId: "ext-prompt-2", runId: "ext-run-2", startedAt: 200, version: 1 },
        id: "boundary-2",
        type: "custom",
      },
    ]);
