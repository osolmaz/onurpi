...
- Source commit: `758837b13863291984bf0a68c6bdd7c224929cd3`
- Package source: exact npm release `0.14.0`
- License: MIT
...
`0.14.0` keeps the current SQLite schema and adds a verified terminal decision that can restart a
supported completed, failed, or cancelled workflow from its original input.
